  ...
  return (
    <section className={styles.about} id="about" ref={ref}>
      ...
      <div className={styles.bioRow}>
        ...
        <div className={`${styles.jsonCard} reveal reveal-right reveal-delay-2`}>
          <div className={styles.jsonLine}><span className={styles.jBrace}>{'{'}</span></div>
          <div className={styles.jsonLine}>
            <span className={styles.jKey}>&nbsp;&nbsp;"location"</span>
            <span className={styles.jColon}>: </span>
            <span className={styles.jStr}>"Stockholm, Sweden"</span><span className={styles.jComma}>,</span>
          </div>
          <div className={styles.jsonLine}>
            <span className={styles.jKey}>&nbsp;&nbsp;"degree"</span>
            <span className={styles.jColon}>: </span>
            <span className={styles.jStr}>"MSc CS @ Stockholm Uni"</span><span className={styles.jComma}>,</span>
          </div>
          <div className={styles.jsonLine}>
            <span className={styles.jKey}>&nbsp;&nbsp;"experience"</span>
            <span className={styles.jColon}>: </span>
            <span className={styles.jStr}>"1.5 years DE"</span><span className={styles.jComma}>,</span>
          </div>
          <div className={styles.jsonLine}>
            <span className={styles.jKey}>&nbsp;&nbsp;"open_to_work"</span>
            <span className={styles.jColon}>: </span>
            <span className={styles.jBool}>true</span><span className={styles.jComma}>,</span>
          </div>
          <div className={styles.jsonLine}>
            <span className={styles.jKey}>&nbsp;&nbsp;"prefers"</span>
            <span className={styles.jColon}>: </span>
            <span className={styles.jStr}>"remote / hybrid"</span>
          </div>
          <div className={styles.jsonLine}><span className={styles.jBrace}>{'}'}</span></div>
        </div>
      </div>
      ...
      <div className={styles.skillsSection}>
        ...
        <div className={styles.skillGrid}>
          {skills.map((s, i) => (
            <div key={s.cat} className={`${styles.skillGroup} reveal reveal-scale reveal-delay-${(i % 5) + 1}`}>
      ...
      <div className={styles.timelineSection}>
        ...
        <div className={styles.timeline}>
          {timeline.map((t, i) => (
            <div key={i} className={`${styles.tlItem} reveal reveal-delay-${i + 1}`}>
              <div className={styles.tlLeft}>
                <div className={styles.tlYear}>{t.year}</div>
                <span className={styles.tlTag} style={{ '--tc': tagColor[t.tag] }}>
                  {t.tag}
                </span>
              </div>
